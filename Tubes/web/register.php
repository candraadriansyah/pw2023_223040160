...
<body>
    ...
    <div class="container mt-4">
        <div class="card card-login p-4 bg-secondart rounded-3 shadow border border-secondary">
            <div class="card-body">
                <h2 class="card-title text-center mb-3">Candra Tech.</h2>
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control border-2 border-dark" name="password2" placeholder="Masukkan ulang password">
                    </div>
